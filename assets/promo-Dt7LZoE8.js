...
<a class="banner" style="--acc: 255 122 0; --acc-soft: 255 190 120" href="${e(`https://cubenorix.github.io/#/project/`+encodeURIComponent(String(t.title||``).toLowerCase().replace(/[^a-z0-9]+/g,`-`)))}" target="_blank" rel="noopener">
  ...
  <span class="inner">
    <svg class="cube" viewBox="0 0 100 100"><g fill="none" stroke="#FF7A00" stroke-width="7.5" stroke-linejoin="round" stroke-linecap="round"><path d="M50 3 L97 26.5 L97 73.5 L50 97 L3 73.5 L3 26.5 Z"/><path d="M3 26.5 L97 73.5 M97 26.5 L3 73.5 M50 50 L50 97"/></g></svg>
